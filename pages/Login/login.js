...
Page({
  ...
  loginAction: function () {
    ...
    var urlParam = {
      "AppID": app.AppID,//wx9e4895714e80e3f1
      "BrowserInfo": "Andriod",
      "LoginIP": "192.168.2.90",
      "MacAddress": '',
      "MachineType": app.globalData.phoneType,
  ...
  getsubsystemUrlRequest: function () {
    ...
    var params = { "sysID": "E45", }
    console.log(schoolUrl,params)
    subsystemUrlApi(schoolUrl, params).then(data => {
      ...
      try {
        ...
        if (systemUrl) {
          app.globalData.assetSystemUrl = systemUrl;
          console.log(app.globalData.assetSystemUrl)
          wx.redirectTo({
